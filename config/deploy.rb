...
set :linked_files, %w{config/database.yml config/secrets.yml config/newrelic.yml config/email_addresses.yml config/sidekiq_pro_path.yml config/paypal.yml}
